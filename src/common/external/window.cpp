...
Window::Window(int w, int h, const TCHAR *title)
{
    WNDCLASS   wc = {CS_BYTEALIGNCLIENT,
                   ...
                   _T("SCREEN_WINDOW")};
    BITMAPINFO bi = {
        {sizeof(BITMAPINFOHEADER), w, -h, 1, 32, BI_RGB, (DWORD)w * h * 4, 0, 0, 0, 0}};
    RECT   rect = {0, 0, w, h};
    int    wx, wy, sx, sy;
    LPVOID ptr;
    HDC    hDC;
    ...
    screen_handle = CreateWindow(_T("SCREEN_WINDOW"),
                                 title,
...
bool Window::set_title(const TCHAR *title)
{
